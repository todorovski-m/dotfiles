...
-- Baraj go teksot od tekovnata linija vo vnms*.tex
-- substitute(text, "\\", "\\\\\\", "") replace \ with \\
--vim.cmd [[
--function! SearchTextVNMS()
  --exec "normal! 0y$"
  --let text = getreg("\"")
  --let text = substitute(text, "\\", "\\\\\\", "")
  --echo text
  --silent exec "vimgrep '\\C" . text . "' vnms*.tex sliki/**/*.tex"
--endfunction
--]]
--keymap("n", "<C-k>", ":call SearchTextVNMS()<CR>", opts)
